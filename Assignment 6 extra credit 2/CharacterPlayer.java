...
public class CharacterPlayer implements Comparable<CharacterPlayer> {
    public int xCord;
    public int yCord;
    public char name;

    public CharacterPlayer(char name, int xCord, int yCord) {
        this.name = name;
        this.xCord = xCord;
        this.yCord = yCord;
    }
    ...
    public int compareTo(CharacterPlayer p) {
