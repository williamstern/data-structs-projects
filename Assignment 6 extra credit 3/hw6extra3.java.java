/*
  ...
  Description of this file:
    ...
    this file calculates the path for the creatures using disjstras algorithm but does it for multiple rounds
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (!gameEnded) {
            ...
            for (int i = 0; i < zombQ.length; i++) {
                ...
                if (v != null) { // prints path if its not null
                    char movement = printVertexCords(v, zombQ[i]);
